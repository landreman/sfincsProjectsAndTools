...
profilesWOMCFilename='/global/scratch2/sd/landrema/W7X_files_from_Yuriy/profilesWithoutMomentumConservation.txt';
...
data=importdata(profilesWOMCFilename);

r_over_as_YuriyWOMC = data.data(:,1);
ne_YuriyWOMC = data.data(:,3);
ni_YuriyWOMC = data.data(:,4);
Te_YuriyWOMC = data.data(:,5);
Ti_YuriyWOMC = data.data(:,6);
Er_YuriyWOMC = data.data(:,7);
particleFlux_YuriyWOMC = data.data(:,8);
Qe_YuriyWOMC = data.data(:,10);
Qi_YuriyWOMC = data.data(:,11);
je_YuriyWOMC = data.data(:,12);
ji_YuriyWOMC = data.data(:,13);

fprintf('Max differences with and without momentum conservation:\n')
fprintf('  r/a: %g\n',max(r_over_as_Yuriy - r_over_as_YuriyWOMC))
fprintf('  n: %g\n',max(ne_Yuriy - ne_YuriyWOMC))
fprintf('  Te: %g\n',max(Te_Yuriy - Te_YuriyWOMC))
fprintf('  Ti: %g\n',max(Ti_Yuriy - Ti_YuriyWOMC))
...
hold on
%plot(r_over_as_YuriyWOMC, ne_YuriyWOMC, '.c')
xlabel('r/a')
ylabel('n [10^{20} / m^3]')
...
%plot(r_over_as_YuriyWOMC, Te_YuriyWOMC, '.c')
%plot(r_over_as_YuriyWOMC, Ti_YuriyWOMC, '.m')
xlabel('r/a')
ylabel('T [keV]')
...
hold on
plot(r_over_as_YuriyWOMC, Er_YuriyWOMC, ':m')
for iPhysics = 1:4
...
hold on
plot(r_over_as_YuriyWOMC, particleFlux_YuriyWOMC, ':m')
for iPhysics = 1:4
...
hold on
plot(r_over_as_YuriyWOMC, Qi_YuriyWOMC, ':m')
for iPhysics = 1:4
...
hold on
plot(r_over_as_YuriyWOMC, Qe_YuriyWOMC, ':m')
for iPhysics = 1:4
...
hold on
plot(r_over_as_YuriyWOMC, ji_YuriyWOMC, ':m')
for iPhysics = 1:4
...
hold on
plot(r_over_as_YuriyWOMC, je_YuriyWOMC, ':m')
for iPhysics = 1:4
...
hold on
plot(r_over_as_YuriyWOMC, ji_YuriyWOMC + je_YuriyWOMC, ':m')
for iPhysics = 1:4
...
legendHandle = legend(...
    'DKES calculations by Turkin, with momentum correction',...
    'DKES calculations by Turkin, without momentum correction',...
