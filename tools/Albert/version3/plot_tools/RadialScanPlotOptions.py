...
FigSize = (12,10) #LHD113208t4640 Er scan, Flux scan
#FigSize = (13.5,10)
#FigSize = (12,12)
font = {'size':35}
...
yAxisLabelCoords = [-0.11,0.5] #LHD113208t4640 Er scan, Flux scan
#yAxisLabelCoords = [-0.09,0.5] #CONTOUR PLOT WITHOUT COLORBAR

LeftMargin = 0.15 #LHD113208t4640 Er scan, Flux scan
#LeftMargin = 0.135 #CONTOUR PLOT WITHOUT COLORBAR

RightMargin = 0.95 #LHD113208t4640 Er scan, Flux scan
#RightMargin = 0.935 #CONTOUR PLOT WITHOUT COLORBAR

TopMargin = 0.95 #LHD113208t4640 Er scan, Flux scan
...
LegendBBoxToAnchor = [0.005, 0.665, 1., .102] #LHD113208t4640 Er scan
