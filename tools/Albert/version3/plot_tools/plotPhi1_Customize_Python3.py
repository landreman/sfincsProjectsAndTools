...
cbarTicks = [-200.0, -50.0, -20.0, -5.0, -1.0, 0.0, 1.0, 5.0, 20.0, 50.0, 200.0] #None for automatic
#cbarTicks = [-5.0, -2.5 -1.0, -0.5, 0.0, 0.5, 1.0, 2.5, 5.0]
#cbarTicks =None

zMin = -250.0 #None to get the default value
zMax = 250.0 #None to get the default value
#zMin = None
#zMax = None
zLogAxis = True
...
cbar.ax.set_ylabel(r'$\Phi_1$'+ " " + r'$\mathrm{[V]}$', rotation=0, labelpad=PhiLabelPad)
